<?php 
    ...
    $query = "select * from obj_type where objty = 'CUST'";
    $param = array();
    $objt  = $util->execQuery($query,$param,1);
    
    $query = "select * from usr_auth where objty = 'CUST' and user_id = ? and objky not in (?)";
...
?>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
            <select class="form-control" id="cust_id" onchange="setVendor(this);">
